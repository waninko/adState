  ...
  <div id="wrapper">
    ...
    <div id="main">
      ...
      <input
        ...
        name="activites"
        value="Football"
        :disabled="activities.length >= 2 && !activities.includes('football')"
        v-model="activities"
      >
      ...
      <input
        ...
        name="activites"
        value="Basketball"
        :disabled="activities.length >= 2 && !activities.includes('basketball')"
        v-model="activities"
      >
      ...
      <input
        ...
        name="activites"
        value="Tennis"
        :disabled="activities.length >= 2 && !activities.includes('tennis')"
        v-model="activities"
      >
      ...
      <input
        ...
        name="activites"
        value="E-sports"
        :disabled="activities.length >= 2 && !activities.includes('e-sports')"
        v-model="activities"
      >
  ...
  methods: {
    ...
    async save() {
      ...
      if (this.activities.length > 2) {
        alert(
          "You have to select less than 3 activities because of time-related issues."
        );
      } else if (this.activities.length == 0) {
        alert("You have to select atleast one activity.");
      } 
      console.log("dette ligger i data: ", data);
    }
  }
};
</script>